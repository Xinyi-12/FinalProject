...
public class Person extends Point {
   ...
   // boolean isIsolation = false;
    ...
    public void confirmAction(){
        ...
        //处理病死者
        if (myPanel.getWorldTime() >= dieMoment && dieMoment > 0) {
    ...
    public void freezeAction(){
        ...
        //处理治愈者
        if (myPanel.getWorldTime() >= cureMoment && cureMoment > 0) {
    ...
    public int getDieMoment() {
        return dieMoment;
    }

    public int getCureMoment() {
        return cureMoment;
    }

    public Bed getUseBed() {
        return useBed;
    }
